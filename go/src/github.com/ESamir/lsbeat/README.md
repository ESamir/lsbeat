...
```
git remote set-url origin https://github.com/ESamir/lsbeat
...
```
mkdir -p ${GOPATH}/github.com/ESamir
cd ${GOPATH}/github.com/ESamir
git clone https://github.com/ESamir/lsbeat
```
